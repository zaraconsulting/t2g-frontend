                ...
                <div className="card-body p-4">
                    <div className="row">
                        <div className="col-12">
                            <h2 className={`${ props.dataType === props.selectionListData ? 'text-white fw-900' : 'text-grey-900 fw-900'} display1-size mt-2 mb-1 ls-3 lh-1`}>{ props[props.dataType] ? props[props.dataType].length: 0 }</h2>
