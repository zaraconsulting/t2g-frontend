        ...
        <div className="dashboard-tab cart-wrapper p-5 bg-white rounded-lg shadow-xs">
          <div className="row">
            <div className="col-lg-4 offset-sm-4 text-center">
              ...
              <h2 className="fw-900 font-sm text-grey-900 mt-3">
                Surfiya Zakir
                        </h2>
              ...
              <a
                href="link"
                className="p-3 alert-primary text-primary font-xsss fw-500 mt-2 rounded-lg"
              >
                Upload New Photo
                        </a>
            </div>
          ...
          <form action="link">
            ...
            <div className="row">
              <div className="col-lg-12">
                <h4 className="mb-4 font-xs fw-700 mont-font">
                  Social Network
                          </h4>
              </div>
              <div className="col-lg-6 mb-3">
            ...
            <div className="row">
              ...
              <div className="col-lg-12 mb-5 mt-2">
                <a href="link" className="bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-lg d-inline-block" >Save</a>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 mb-3">
                <div className="form-gorup">
                  <label className="mont-font fw-600 font-xsss" htmlFor="comment-name">Pincode</label>
                  <input type="text" name="comment-name" className="form-control" />
                </div>
              </div>
